...
function updateStats(){document.getElementById("quizScore").textContent=localStorage.getItem("lastQuiz")||"—";document.getElementById("progressCount").textContent=localStorage.getItem("completedPracticals")||"0"}
updateStats();
